...
<body>
    ...
    <div id="uploadedPhotosContainer" style="position: absolute; right: 140px; top: 320px; width: auto; border: 1px solid #ccc; padding: 10px; background: #ffffff; box-shadow: 0 0 5px rgba(0,0,0,0.1); overflow-y: auto; max-height: 60vh; margin-left: auto; margin-right: auto; padding-left: 5px;">
